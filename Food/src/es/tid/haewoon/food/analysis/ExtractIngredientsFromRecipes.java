...
import es.tid.haewoon.food.util.ElBulliRecipe;
...
public class ExtractIngredientsFromRecipes {
    ...
    public void run(String root, String pattern, boolean append) throws IOException {
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter(targetPath + File.separator + "all", append));
    ...
    public static void main(String[] args) throws IOException {
        ...
        eifr.run(Constants.CD3_RECIPES_PATH, Constants.RECIPE_PATTERN, true);
    }
}
