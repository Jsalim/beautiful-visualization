...
public class CoordinationConverter {
    static Logger logger = Logger.getLogger(CoordinationConverter.class);

	public CoordinationConverter() {}

	public static void main(String[] args) {
	    String UTM = "31 T 236398 5070042";
		CoordinationConverter cc = new CoordinationConverter();
		double[] latlon = cc.utm2LatLon(UTM);
		logger.debug(UTM + " -> " + latlon[0] + ", " + latlon[1]);
	}
